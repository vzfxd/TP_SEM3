...
import eu.jpereira.trainings.designpatterns.creational.factorymethod.Factory.HTMLReportFactory;
import eu.jpereira.trainings.designpatterns.creational.factorymethod.Factory.JSONReportFactory;
import eu.jpereira.trainings.designpatterns.creational.factorymethod.Factory.PDFReportFactory;
import eu.jpereira.trainings.designpatterns.creational.factorymethod.Factory.XMLReportFactory;
...
public class ReportGeneratorTest extends AbstractReportingTest{
	...
	public void testCreateJSONReport() {
		...
		JSONReportFactory factory = new JSONReportFactory(reportData);
		Report generatedReport = generator.generateReport(factory);
	...
	public void testCreateXMLReport() {
		ReportData reportData = createDummyReportData();
		ReportGenerator generator = new ReportGenerator();
		XMLReportFactory factory = new XMLReportFactory(reportData);
		Report generatedReport = generator.generateReport(factory);
	...
	public void testCreateHTMLReport() {
		ReportData reportData = createDummyReportData();
		ReportGenerator generator = new ReportGenerator();
		HTMLReportFactory factory = new HTMLReportFactory(reportData);
		Report generatedReport = generator.generateReport(factory);
	...
	public void testCreatePDFReport() {
		ReportData reportData = createDummyReportData();
		ReportGenerator generator = new ReportGenerator();
		PDFReportFactory factory = new PDFReportFactory(reportData);
		Report generatedReport = generator.generateReport(factory);
